...
<head>
    ...
    <style>
        ...
        .card { background: white; padding: 15px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); flex: 1; text-align: center; }
        .card h3 { margin: 0; color: #777; font-size: 14px; }
        .card p { margin: 10px 0 0; font-size: 24px; font-weight: bold; color: #e2ad39; }
        table { width: 100%; border-collapse: collapse; background: white; border-radius: 10px; overflow: hidden; }
        th, td { padding: 12px; border-bottom: 1px solid #eee; text-align: left; }
        th { background: #e2ad39; color: white; }
...
<body>
    ...
    <div class="stats">
        <div class="card"><h3>今日成人總數</h3><p><?php echo (int)$total_res['total_adults']; ?> 人</p></div>
        <div class="card"><h3>今日幼兒總數</h3><p><?php echo (int)$total_res['total_children']; ?> 人</p></div>
        <div class="card"><h3>總進館組數</h3><p><?php echo $result->num_rows; ?> 組</p></div>
    </div>
